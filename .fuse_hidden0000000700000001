...
CAT("airbrakes").questions = [
  {
    ...
    options:["About 60 psi","About 100 psi","Usually around 120–140 psi","Above 175 psi"],
    answer:2,
    explanation:"The governor stops the compressor (cut-out) at the vehicle's set pressure — usually around 120–140 psi — and lets it resume (cut-in) when pressure drops. Always know your vehicle's specs.",
    handbook:"Build air pressure to governor cut-out, usually around 120 to 140 psi; know your vehicle's requirements.",
  ...
  },
  {
    ...
    options:["About 50 psi","About 60 psi","The normal operating range, up to governor cut-out (around 120–140 psi)","Exactly 150 psi"],
    answer:2,
    explanation:"Wait until the system charges into the normal operating range — up to the governor cut-out, usually around 120–140 psi — before you start moving, so you have full braking ability.",
    handbook:"Before driving, build air pressure to governor cut-out (usually around 120–140 psi); know your vehicle's requirements.",
    hbref:"§5.3 Inspecting Air Brakes"
  },
  {
...
CAT("airbrakes").questions.push(
  ...
  },
  {
    ...
    answer:1,
    explanation:"When tank pressure drops to about 100 psi, the governor lets the compressor resume pumping (cut-in). It cuts out again at the set pressure (usually around 120–140 psi). This cycle keeps pressure in range.",
...
CAT("general").questions = [
  ...
  {q:"The following-distance rule for a heavy vehicle is:",options:["2 seconds always","1 second per 10 ft, +1 over 40 mph","3 car lengths","100 ft at any speed"],answer:1,explanation:"One second per 10 ft of length; add one second over 40 mph.",handbook:"Allow one second per 10 feet of length, plus one over 40 mph.",hbref:"§2.7 Space"},
  ...
  {q:"A 'hazard' on the road is:",options:["Only a speeding car","Any condition or user that could be a danger","Just bad weather","Only a crash"],answer:1,explanation:"Anything that could become an emergency.",handbook:"A hazard is any road condition or user that is a possible danger.",hbref:"§2.8 Hazards"},
  ...
  {q:"To avoid glare from oncoming headlights, look:",options:["Straight at them","To the right edge of your lane","At your dash","Down at the road"],answer:1,explanation:"Look toward the right edge/markings until they pass.",handbook:"Do not look at oncoming headlights; look to the right edge of your lane.",hbref:"§2.10 Night"},
  {q:"In dense fog you should use:",options:["High beams","Low beams and slow down","Hazards only","No lights"],answer:1,explanation:"High beams reflect back; use low beams and slow down.",handbook:"Use low beams in fog and slow down.",hbref:"§2.11 Fog"},
  ...
  {q:"On a long downgrade, speed is controlled mainly by:",options:["Riding the brakes","A low gear and engine braking","The parking brake","Coasting"],answer:1,explanation:"Engine braking in a low gear; brakes only supplement.",handbook:"Use a low gear and engine braking as the main control on a downgrade.",hbref:"§2.15 Mountain"},
  ...
  {q:"If a front tire blows out, your first action is to:",options:["Brake hard","Hold the wheel, stay off the brake","Steer sharply","Shift to neutral"],answer:1,explanation:"Grip the wheel, stay off the brake, let it slow, then ease off the road.",handbook:"On a blowout, hold the wheel firmly and stay off the brake.",hbref:"§2.16 Emergencies"},
  ...
  {q:"To recover from a drive-wheel (rear) skid, you should:",options:["Brake harder","Stop accelerating and steer","Lock the brakes","Speed up"],answer:1,explanation:"Ease off the accelerator and steer where you want to go.",handbook:"To correct a drive-wheel skid, stop accelerating and steer.",hbref:"§2.18 Skids"},
  ...
  {q:"First at an accident scene, you should:",options:["Move the injured","Protect the area with warning devices","Leave to find a phone","Push the wrecks aside"],answer:1,explanation:"Prevent another crash first; usually do not move the injured.",handbook:"At a crash, first keep another accident from happening.",hbref:"§2.19 Accidents"},
  {q:"For an engine fire you should:",options:["Open the hood wide","Keep the hood down if you can","Add fuel","Drive faster"],answer:1,explanation:"Opening the hood adds oxygen; shut off the engine.",handbook:"For an engine fire, do not open the hood if you can avoid it.",hbref:"§2.20 Fires"},
  ...
  {q:"The minimum tie-down rule for cargo is:",options:["One total","One per 10 ft, at least two","One per 25 ft","Only over 20 ft"],answer:1,explanation:"At least one per 10 ft, minimum two.",handbook:"Use at least one tie-down per 10 feet of cargo, minimum two.",hbref:"§3.2 Cargo"},
  ...
  {q:"A Texas Class A CDL is for combinations with a GCWR of:",options:["16,001 lb+","26,001 lb+ towing over 10,000 lb","10,000 lb+","40,000 lb+"],answer:1,explanation:"GCWR 26,001+ where the towed unit is over 10,000 lb.",handbook:"Class A: GCWR 26,001 pounds or more, towed unit over 10,000 pounds.",hbref:"§1 CDL Classes"},
  ...
  {q:"A header board ('headache rack') is there to:",options:["Hold the spare tire","Stop cargo from shifting into the cab","Save fuel","Mark a wide load"],answer:1,explanation:"It protects you from forward-shifting cargo.",handbook:"Header boards protect the driver from cargo shifting forward.",hbref:"§3.2 Cargo"},
  ...
  {q:"Stopping is not always the safest action because:",options:["It wastes time","Steering away can be quicker","Brakes overheat","It is illegal"],answer:1,explanation:"You can often steer to miss a hazard faster than you can stop.",handbook:"Stopping is not always safest; steering to miss may be quicker.",hbref:"§2.16 Emergencies"},
...
CAT("airbrakes").questions = [
  ...
  {q:"The governor stops the compressor (cut-out) at about:",options:["60 psi","100 psi","120–140 psi","175 psi"],answer:2,explanation:"Cut-out is usually around 120–140 psi.",handbook:"Build air pressure to governor cut-out, usually 120 to 140 psi.",hbref:"§5.1 Governor"},
  ...
  {q:"The application pressure gauge shows:",options:["Tank pressure","Pressure applied to the brakes","Engine rpm","Tire pressure"],answer:1,explanation:"It shows how much pressure you are applying.",handbook:"The application gauge shows how much pressure you apply to the brakes.",hbref:"§5.1 Gauges"},
  ...
  {q:"In stab braking, you reapply the brakes:",options:["Right away","After the wheels roll again","After 10 seconds","Never"],answer:1,explanation:"Release when locked; reapply once rolling (up to 1 sec).",handbook:"Stab braking: release when locked, reapply once wheels roll.",hbref:"§5.4 Using"},
  ...
  {q:"ABS is required on truck tractors built on or after:",options:["1990","March 1, 1997","2005","2010"],answer:1,explanation:"Tractors 3/1/1997; other vehicles and trailers 3/1/1998.",handbook:"ABS is required on tractors made on or after March 1, 1997.",hbref:"§5.1 ABS"},
  ...
  {q:"Before driving, let the air system charge to:",options:["About 50 psi","The normal range (about 120–140 psi)","Exactly 150 psi","Any pressure"],answer:1,explanation:"Charge to the normal operating range before moving.",handbook:"Wait for pressure to build to the normal range before driving.",hbref:"§5.3 Inspection"},
  {q:"Why check the air-compressor drive belt (if belt-driven)?",options:["It runs the radio","A loose belt may not build enough air","It cools the brakes","It charges the trailer"],answer:1,explanation:"A slipping belt means the compressor can't keep up.",handbook:"If belt-driven, check the compressor belt's condition and tightness.",hbref:"§5.3 Inspection"},
...
CAT("combination").questions = [
  ...
  {q:"The tractor protection valve is there to:",options:["Inflate the tires","Keep air in the tractor if the trailer breaks away","Raise the landing gear","Lock the fifth wheel"],answer:1,explanation:"It closes to preserve tractor air during a breakaway or leak.",handbook:"The tractor protection valve keeps air in the tractor if the trailer breaks away.",hbref:"§6.2 Air Brakes"},
  ...
  {q:"The tug test checks the coupling by:",options:["Tapping the trailer","Pulling against locked trailer brakes","Checking the lights","Listening for a click"],answer:1,explanation:"Pull gently forward; the trailer should stay attached.",handbook:"Test the coupling by pulling against the locked trailer brakes.",hbref:"§6.4 Coupling"},
  {q:"Before driving, the landing gear should be:",options:["Partway down","Fully raised, handle secured","Touching the road","Removed"],answer:1,explanation:"Fully up so it does not catch; secure the crank handle.",handbook:"The landing gear must be fully raised with the handle secured.",hbref:"§6.5 Inspection"},
  ...
  {q:"A quick, hard steering move can 'crack the whip,' which means:",options:["The cab spins out","The trailer whips and can flip","The brakes fade","The engine stalls"],answer:1,explanation:"Rearward amplification; steer gently and smoothly.",handbook:"A sudden steering move can crack the whip and flip the trailer.",hbref:"§6.1 Driving"},
  ...
  {q:"Losing pressure in the emergency line causes:",options:["Nothing to happen","The trailer emergency brakes to apply","The trailer to speed up","The lights to fail"],answer:1,explanation:"A breakaway applies the trailer emergency brakes.",handbook:"Loss of emergency-line pressure applies the trailer emergency brakes.",hbref:"§6.2 Air Brakes"},
  ...
  {q:"The fifth-wheel release arm should be:",options:["Pulled open","Locked, safety latch closed","Removed","Loose"],answer:1,explanation:"Engaged/locked with the safety latch over it.",handbook:"The release arm must be locked with the safety latch closed.",hbref:"§6.5 Inspection"},
  ...
  {q:"When uncoupling, before pulling out you should:",options:["Raise the landing gear","Lower the landing gear to support the trailer","Release the trailer brakes","Drive forward fast"],answer:1,explanation:"Lower the landing gear, disconnect lines, then unlock.",handbook:"Lower the landing gear to support the trailer before uncoupling.",hbref:"§6.4 Coupling"},
  ...
  {q:"Your low trailer is stuck on a railroad crossing. You should:",options:["Rock it free","Get out and call the posted emergency number","Unhook on the tracks","Wait inside the cab"],answer:1,explanation:"Leave the vehicle and call using the DOT crossing number.",handbook:"If stuck on the tracks, get out and away and call with the DOT crossing number.",hbref:"§6.1 Railroad"}
];
